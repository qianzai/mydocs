...
var sidecar = function (t) {
    ...
    var n = Object.assign || function (t) {
        ...
        return t
    }, o = i(1), a = r(o), u = i(3), M = r(u), c = function (t, e) {
        return t[e] || function () {
            return t[e] = {}, t[e]
        }()
    }, s = {Chat: M.default}, l = n({}, c(window, "gitter"), s), d = new a.default("gitter-sidecar-ready", {detail: s});
    ...
    function i(t, e) {
        var i = e.bubbles, r = void 0 !== i && i, n = e.cancelable, o = void 0 !== n && n, a = e.detail,
            u = void 0 === a ? void 0 : a, M = void 0;
        try {
            M = new window.CustomEvent(t, {bubbles: r, cancelable: o, detail: u})
        } catch (e) {
    ...
    Object.defineProperty(e, "__esModule", {value: !0}), e.default = i, i.prototype = window.Event.prototype
}, function (t, e) {
    "use strict";
    ...
    var a = function () {
            ...
            return t
        }, M = i(2), c = n(M), s = i(1), l = n(s), d = i(5), L = n(d), N = i(7), f = n(N), g = i(4), x = r(g), y = i(6),
        j = n(y), T = function (t) {
            if (t) {
            ...
            return x.on(t, "click keydown", i), function () {
                x.off(t, "click keydown", i)
            }
        }, h = function () {
            var t = new L.default, e = t.createElement("style");
            return e.type = "text/css", e.innerHTML = f.default, x.prependElementTo(e, (0, x.default)("head")[0]), t
        }, w = function (t) {
            var e = new L.default, i = t.targetElement;
            return i.forEach(function (i) {
                var r = b(t, i);
                if (r.room) {
                    var n = e.createElement("iframe");
                    n.setAttribute("frameborder", "0"), n.src = "" + t.host + r.room + "/~embed", i.appendChild(n)
                } else console.error("Gitter Sidecar: No room specified for targetElement", i)
            }), e
        }, p = function (t) {
            var e = t.options, i = new L.default;
            return e.targetElement.forEach(function (r) {
                ...
                o.classList.add("gitter-chat-embed-action-bar-item"), o.classList.add("gitter-chat-embed-action-bar-item-pop-out"), o.setAttribute("aria-label", "Open Chat in Gitter.im"), o.setAttribute("href", "" + e.host + e.room), o.setAttribute("target", "_blank"), o.setAttribute("rel", "noopener"), n.appendChild(o);
                var a = i.createElement("button");
                a.classList.add("gitter-chat-embed-action-bar-item"), a.classList.add("gitter-chat-embed-action-bar-item-collapse-chat"), a.setAttribute("aria-label", "Collapse Gitter Chat"), z(a, function (e) {
                    t.toggleChat(!1), e.preventDefault()
                }), n.appendChild(a)
            }), i
        }, m = document.body || document.documentElement, v = {
            room: void 0,
        ...
        }, I = (0, c.default)("DEFAULTS"), A = (0, c.default)("OPTIONS"), C = (0, c.default)("ELEMENTSTORE"),
        S = (0, c.default)("EVENTHANDLESTORE"), O = (0, c.default)("INIT"), k = (0, c.default)("ISEMBEDDED"),
        U = (0, c.default)("EMBEDCHATONCE"), Y = (0, c.default)("TOGGLETARGETELEMENTS"), Q = function () {
            function t() {
                var e = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : {};
                o(this, t), this[C] = new L.default, this[S] = [], this[I] = v, this[A] = u({}, this[I], e), this[O]()
            }

            return a(t, [{
                key: O, value: function () {
                    var t = this, e = this[A];
                    e.useStyles && this[C].add(h()), e.targetElement = (0, x.default)(e.targetElement || function () {
                        var e = t[C].createElement("aside");
                        return e.classList.add("gitter-chat-embed"), e.classList.add("is-collapsed"), m.appendChild(e), e
                    ...
                    }), p(this), e.preload && this.toggleChat(!1), e.showChatByDefault ? this.toggleChat(!0) : (void 0 === e.activationElement || e.activationElement === !0 ? e.activationElement = (0, x.default)(function () {
                        var i = t[C].createElement("a");
                        return i.href = "" + e.host + e.room, i.innerHTML = "Open Chat", i.classList.add("gitter-open-chat-button"), m.appendChild(i), i
                    }()) : e.activationElement && (e.activationElement = (0, x.default)(e.activationElement)), e.activationElement && (z(e.activationElement, function (e) {
                        ...
                        x.on(t, "gitter-chat-toggle", function (t) {
                            ...
                            e.activationElement.forEach(function (t) {
                                x.toggleClass(t, "is-collapsed", i)
                            })
                        })
                    })));
                    var i = z((0, x.default)(".js-gitter-toggle-chat-button"), function (e) {
                        var i = T(e.target.getAttribute("data-gitter-toggle-chat-state"));
                        t.toggleChat(null !== i ? i : "toggle"), e.preventDefault()
                    });
                    this[S].push(i), e.targetElement.forEach(function (e) {
                        var i = new l.default("gitter-chat-started", {detail: {chat: t}});
                        e.dispatchEvent(i)
                    });
                    var r = new l.default("gitter-sidecar-instance-started", {detail: {chat: this}});
                    document.dispatchEvent(r)
                }
            }, {
                key: U, value: function () {
                    if (!this[k]) {
                        var t = this[A], e = w(t);
                        this[C].add(e)
                    }
                ...
                key: Y, value: function (t) {
                    ...
                    i.forEach(function (e) {
                        "toggle" === t ? x.toggleClass(e, "is-collapsed") : x.toggleClass(e, "is-collapsed", !t);
                        var i = new l.default("gitter-chat-toggle", {detail: {state: t}});
                        e.dispatchEvent(i)
                    })
                }
            }, {
                key: "toggleChat", value: function (t) {
                    var e = this, i = this[A];
                    if (t && !this[k]) {
    ...
    Object.defineProperty(e, "__esModule", {value: !0}), e.forEach = r, e.on = n, e.off = o, e.prependElementTo = a, e.toggleClass = u;
    var M = function () {
        ...
        return r(t, [{
            ...
            key: "add", value: function () {
                ...
                var n = [].concat(i).reduce(function (e, i) {
                    return i ? i instanceof t ? e.concat(i.elements) : e.concat(i) : e
                }, []);
    ...
    function i(t) {
        ...
        return Object.keys(t).forEach(function (i) {
            Object.defineProperty(e, i, {value: t[i], writable: !1, configurable: !1})
        }), e
    }
